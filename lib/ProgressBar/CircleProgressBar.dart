...
class FUICircleProgressBar extends StatefulWidget {
  final Duration animationDuration;
  final Color backgroundColor;
  final Color foregroundColor;
  final double value;

  const FUICircleProgressBar({
    Key key,
  ...
  @override
  FUICircleProgressBarState createState() {
    return FUICircleProgressBarState();
  }
}

class FUICircleProgressBarState extends State<FUICircleProgressBar>
  ...
  @override
  void didUpdateWidget(FUICircleProgressBar oldWidget) {
    ...
    return AspectRatio(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          return CustomPaint(
            child: child,
            foregroundPainter: FUICircleProgressBarPainter(
...
class FUICircleProgressBarPainter extends CustomPainter {
  final double percentage;
  final double strokeWidth;
  final Color backgroundColor;
  final Color foregroundColor;

  FUICircleProgressBarPainter({
    this.backgroundColor,
    @required this.foregroundColor,
  ...
  bool shouldRepaint(CustomPainter oldDelegate) {
    final oldPainter = (oldDelegate as FUICircleProgressBarPainter);
